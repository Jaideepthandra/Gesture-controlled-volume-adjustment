Gesture-controlled-volume-adjustment is a project that uses various libraries of python to access the system volume and set the volume to the specified value based on the hand gestures.
